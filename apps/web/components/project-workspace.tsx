...
const exportOptions:Record<string,Array<[string,string]>>={
  proposal:[["Markdown","md"],["Word","docx"],["HTML","html"],["TXT","txt"],["JSON","json"]],script:[["Markdown","md"],["Word","docx"],["HTML","html"],["TXT","txt"],["JSON","json"]],"image-prompt":[["Markdown","md"],["Word","docx"],["HTML","html"],["TXT","txt"],["JSON","json"]],caption:[["Markdown","md"],["Word","docx"],["HTML","html"],["TXT","txt"],["JSON","json"]],report:[["Markdown","md"],["Word","docx"],["HTML","html"],["TXT","txt"],["JSON","json"]],prompt:[["Markdown","md"],["Word","docx"],["HTML","html"],["TXT","txt"],["JSON","json"]],storyboard:[["JSON","json"],["Excel","xlsx"],["CSV","csv"],["Word","docx"]],"video-storyboard":[["JSON","json"],["Excel","xlsx"],["CSV","csv"],["Word","docx"]],schedule:[["JSON","json"],["Excel","xlsx"],["CSV","csv"],["Word","docx"]],handoff:[["JSON","json"],["Excel","xlsx"],["CSV","csv"],["Word","docx"]],image:[["SVG","svg"],["生成记录","json"]],video:[["项目包 ZIP","zip"],["离线预览","html"],["配置 JSON","json"]]
};
